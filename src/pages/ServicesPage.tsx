    ...
    <div className="pt-32 md:pt-40">
      ...
      <section className="section-pad bg-sand-50">
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal>
            <Badge variant="teal" className="mb-6">Our Services</Badge>
            <h1 className="section-heading mb-8">Specialised Support for Every Need</h1>
            <p className="text-xl text-slate-600 leading-relaxed max-w-3xl mx-auto">
              We provide professional counselling across four key areas, ensuring that whatever challenge you are facing, we have the expertise to help.
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <div className="divide-y divide-slate-100">
        {services.map((service, index) => {
          ...
          return (
            <section key={service.id} className={cn("section-pad", isEven ? "bg-white" : "bg-sand-50/50")}>
              <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className={cn("space-y-8", !isEven && "lg:order-2")}>
                  <ScrollReveal>
                    ...
                    <p className="text-teal-600 font-serif italic text-xl mb-6">{service.heroLine}</p>
                ...
                <div className={cn(!isEven && "lg:order-1")}>
                  <ScrollReveal delay={0.2}>
                    <div className="relative mb-12 rounded-[40px] overflow-hidden shadow-2xl aspect-video lg:aspect-square">
                      <img 
                      ...
                      <div className="pt-8 border-t border-slate-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.audiences.map((audience, i) => (
                            <Badge key={i} variant="teal">{audience}</Badge>
                          ))}
                        </div>
                      </div>
                    </div>
      ...
      {/* CTA */}
      <section className="section-pad bg-teal-900 text-white text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
              ...
              <Button variant="outline" size="lg" className="border-teal-400 text-teal-100 hover:bg-teal-800" href="/contact">
                Contact Us
              </Button>
            </div>
          </ScrollReveal>
