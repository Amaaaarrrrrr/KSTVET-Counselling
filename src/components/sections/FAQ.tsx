        ...
        <div className="space-y-8">
          <ScrollReveal>
            ...
            <p className="section-sub">
              Everything you need to know about accessing our services, confidentiality, and what to expect.
            </p>
          </ScrollReveal>

          <ScrollReveal delay={0.2} className="p-8 bg-white rounded-3xl shadow-card border border-slate-100">
            <div className="w-12 h-12 rounded-2xl bg-teal-50 flex items-center justify-center text-teal-600 mb-6">
