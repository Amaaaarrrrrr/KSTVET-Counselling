  ...
  return (
    <section className="section-pad bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="bg-cta-50 rounded-[40px] p-8 md:p-16 border-l-[12px] border-cta-400 shadow-xl relative overflow-hidden">
          {/* Decorative Icon */}
          <ShieldAlert className="absolute -top-10 -right-10 w-64 h-64 text-cta-400/10 opacity-20 rotate-12" />

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
            <div className="space-y-8">
              <ScrollReveal>
                <Badge variant="cta" className="mb-4">Urgent Support</Badge>
              ...
              <ScrollReveal delay={0.2} className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-cta-50">
                  <div className="w-12 h-12 rounded-xl bg-cta-50 flex items-center justify-center text-cta-400">
                    <Phone className="w-6 h-6" />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Emergency Phone</p>
                    <p className="text-xl font-bold text-slate-900">0707 444 222</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-cta-50">
                  <div className="w-12 h-12 rounded-xl bg-cta-50 flex items-center justify-center text-cta-400">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-900">Guidance & Counselling Office (Mon-Fri)</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.4} className="flex flex-wrap gap-4">
                ...
                <Button variant="outline" size="lg" className="bg-white border-cta-400 text-cta-400 hover:bg-cta-50">
              ...
              <ScrollReveal delay={0.3}>
                ...
                <div className="space-y-4">
                  {crisisLines.map((line, i) => (
                    <div key={i} className="flex items-center justify-between p-5 bg-white/60 backdrop-blur-sm rounded-2xl border border-cta-50 hover:border-cta-200 transition-colors">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-cta-50 flex items-center justify-center text-cta-400">
                          <Phone className="w-5 h-5" />
                        </div>
                        <div>
                          <p className="font-bold text-slate-900">{line.name}</p>
                          <p className="text-lg font-serif text-cta-400">{line.number}</p>
                        </div>
                      </div>
                      <Badge variant="cta" size="sm" className="bg-white">{line.status}</Badge>
                    </div>
                  ))}
                </div>
              </ScrollReveal>
              
              <ScrollReveal delay={0.5} className="p-6 bg-white/40 rounded-2xl border border-dashed border-cta-200">
